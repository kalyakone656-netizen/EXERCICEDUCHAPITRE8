...
public class BookShelfSpec {
    ...
    void init() {
        ...
        refactoring = new Book("Refactoring", "Martin Fowler",
    ...
    class IsArranged {
        ...
        @Test
        @DisplayName("by user provided criteria (descending order)")
    ...
    class IsGrouped {
        ...
        void bookshelfGroupedByPublicationYear() {
            ...
            assertThat(booksByYear.get(Year.of(2008))).containsExactly(effectiveJava);
            assertThat(booksByYear.get(Year.of(2004))).containsExactly(codeComplete);
            assertThat(booksByYear.get(Year.of(1975))).containsExactly(mythicalManMonth);
            assertThat(booksByYear.get(Year.of(2018))).containsExactly(refactoring);
        }

        @Test
        @DisplayName("by user provided criteria (author)")
        void bookshelfGroupedByUserProvidedCriteria() {
            ...
            assertThat(booksByAuthor.get("Martin Fowler")).containsExactly(refactoring);
        }
    }
}